 ...
 */
public class BVUnsignedGreaterOrEqual extends BinaryOp {
    ...
    public BVUnsignedGreaterOrEqual(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVUnsignedGreaterOrEqual))
            return false;
        if (obj == this)
            return true;

        BVUnsignedGreaterOrEqual rhs = (BVUnsignedGreaterOrEqual) obj;
