 ...
 */
public class BVSignedGreater extends BinaryOp {
    ...
    public BVSignedGreater(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVSignedGreater))
            return false;
        if (obj == this)
            return true;

        BVSignedGreater rhs = (BVSignedGreater) obj;
