 ...
 */
public class BVSignedRemainder extends BinaryOp {
    ...
    public BVSignedRemainder(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVSignedRemainder))
            return false;
        if (obj == this)
            return true;

        BVSignedRemainder rhs = (BVSignedRemainder) obj;
