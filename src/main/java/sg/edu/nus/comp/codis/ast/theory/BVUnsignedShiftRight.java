 ...
 */
public class BVUnsignedShiftRight extends BinaryOp {
    ...
    public BVUnsignedShiftRight(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVUnsignedShiftRight))
            return false;
        if (obj == this)
            return true;

        BVUnsignedShiftRight rhs = (BVUnsignedShiftRight) obj;
