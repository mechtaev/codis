 ...
 */
public class BVSignedGreaterOrEqual extends BinaryOp {
    ...
    public BVSignedGreaterOrEqual(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVSignedGreaterOrEqual))
            return false;
        if (obj == this)
            return true;

        BVSignedGreaterOrEqual rhs = (BVSignedGreaterOrEqual) obj;
