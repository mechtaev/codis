 ...
 */
public class BVSignedModulo extends BinaryOp {
    ...
    public BVSignedModulo(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVSignedModulo))
            return false;
        if (obj == this)
            return true;

        BVSignedModulo rhs = (BVSignedModulo) obj;
