 ...
 */
public class BVUnsignedLess extends BinaryOp {
    ...
    public BVUnsignedLess(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVUnsignedLess))
            return false;
        if (obj == this)
            return true;

        BVUnsignedLess rhs = (BVUnsignedLess) obj;
