 ...
 */
public class BVSignedShiftRight extends BinaryOp {
    ...
    public BVSignedShiftRight(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVSignedShiftRight))
            return false;
        if (obj == this)
            return true;

        BVSignedShiftRight rhs = (BVSignedShiftRight) obj;
