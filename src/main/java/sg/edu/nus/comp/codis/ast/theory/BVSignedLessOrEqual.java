 ...
 */
public class BVSignedLessOrEqual extends BinaryOp {
    ...
    public BVSignedLessOrEqual(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVSignedLessOrEqual))
            return false;
        if (obj == this)
            return true;

        BVSignedLessOrEqual rhs = (BVSignedLessOrEqual) obj;
