 ...
 */
public class BVUnsignedLessOrEqual extends BinaryOp {
    ...
    public BVUnsignedLessOrEqual(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVUnsignedLessOrEqual))
            return false;
        if (obj == this)
            return true;

        BVUnsignedLessOrEqual rhs = (BVUnsignedLessOrEqual) obj;
