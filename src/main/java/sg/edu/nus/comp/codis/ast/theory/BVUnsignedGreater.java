 ...
 */
public class BVUnsignedGreater extends BinaryOp {
    ...
    public BVUnsignedGreater(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVUnsignedGreater))
            return false;
        if (obj == this)
            return true;

        BVUnsignedGreater rhs = (BVUnsignedGreater) obj;
