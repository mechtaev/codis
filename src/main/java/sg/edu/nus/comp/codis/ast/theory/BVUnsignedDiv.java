 ...
 */
public class BVUnsignedDiv extends BinaryOp {
    ...
    public BVUnsignedDiv(Node left, Node right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BVUnsignedDiv))
            return false;
        if (obj == this)
            return true;

        BVUnsignedDiv rhs = (BVUnsignedDiv) obj;
